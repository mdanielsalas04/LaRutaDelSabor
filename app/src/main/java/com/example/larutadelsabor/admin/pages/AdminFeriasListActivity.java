    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AdminFeriaAdapter(this, listaFerias, new AdminFeriaAdapter.OnItemActionListener() {
            ...
            public void onEdit(Feria feria) {
                // TODO: Abrir actividad de formulario pasando el ID para editar
                Toast.makeText(AdminFeriasListActivity.this, "Editar: " + feria.getTitulo(), Toast.LENGTH_SHORT).show();
            }
        ...
        fabAdd.setOnClickListener(v -> {
            // TODO: Abrir actividad de formulario vacía para crear
            Toast.makeText(this, "Crear nueva feria", Toast.LENGTH_SHORT).show();
        });
